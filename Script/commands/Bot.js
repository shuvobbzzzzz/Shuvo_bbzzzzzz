...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() i") || (event.body.toLowerCase() == "💋")) {
  ...
  if ((event.body.toLowerCase() == "Shuvo") || (event.body.toLowerCase() == "Shuvo vai") || (event.body.toLowerCase() == "@rahat islam") || (event.body.toLowerCase() == "Shuvo")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Shuvo ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rahatッ❤️ তাকে সবাই শুভ  নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>🔰Shuvo_Bot🔰", threadID);
   };
